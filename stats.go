...
func (stats StatsReply) WritePrometheus(w io.Writer) error {
	...
	for _, stat := range []plainStat{
		{text: "orion_stats_counters_json_requests %f\n", value: stats.Counters.JsonRequests},
		{text: "orion_stats_counters_no_payload_requests %f\n", value: stats.Counters.NoPayloadRequests},
		{text: "orion_stats_counters_invalid_requests %f\n", value: stats.Counters.InvalidRequests},
		{text: "orion_stats_counters_notifications_sent %f\n", value: stats.Counters.NotificationsSent},
		{text: "orion_stats_timing_accumulated {at=\"JsonV1Parse\"} %f\n", value: stats.Timing.Accumulated.JsonV1Parse},
		{text: "orion_stats_timing_accumulated {at=\"JsonV2Parse\"} %f\n", value: stats.Timing.Accumulated.JsonV2Parse},
		{text: "orion_stats_timing_accumulated {at=\"MongoBackend\"} %f\n", value: stats.Timing.Accumulated.MongoBackend},
		{text: "orion_stats_timing_accumulated {at=\"MongoReadWait\"} %f\n", value: stats.Timing.Accumulated.MongoReadWait},
		{text: "orion_stats_timing_accumulated {at=\"MongoWriteWait\"} %f\n", value: stats.Timing.Accumulated.MongoWriteWait},
		{text: "orion_stats_timing_accumulated {at=\"MongoCommandWait\"} %f\n", value: stats.Timing.Accumulated.MongoCommandWait},
		{text: "orion_stats_timing_accumulated {at=\"Render\"} %f\n", value: stats.Timing.Accumulated.Render},
		{text: "orion_stats_timing_accumulated_total %f\n", value: stats.Timing.Accumulated.Total},
		{text: "orion_stats_timing_last {at=\"JsonV2Parse\"} %f\n", value: stats.Timing.Last.JsonV2Parse},
		{text: "orion_stats_timing_last {at=\"MongoBackend\"} %f\n", value: stats.Timing.Last.MongoBackend},
		{text: "orion_stats_timing_last {at=\"MongoReadWait\"} %f\n", value: stats.Timing.Last.MongoReadWait},
		{text: "orion_stats_timing_last {at=\"MongoWriteWait\"} %f\n", value: stats.Timing.Last.MongoWriteWait},
		{text: "orion_stats_timing_last {at=\"Render\"} %f\n", value: stats.Timing.Last.Render},
		{text: "orion_stats_timing_last_total %f\n", value: stats.Timing.Last.Total},
		{text: "orion_stats_semwait_request %f\n", value: stats.Semwait.Request},
		{text: "orion_stats_semwait_db_connection_pool %f\n", value: stats.Semwait.DbConnectionPool},
		{text: "orion_stats_semwait_transaction %f\n", value: stats.Semwait.Transaction},
		{text: "orion_stats_semwait_sub_cache %f\n", value: stats.Semwait.SubCache},
		{text: "orion_stats_semwait_connection_context %f\n", value: stats.Semwait.ConnectionContext},
		{text: "orion_stats_semwait_timestat %f\n", value: stats.Semwait.TimeStat},
		{text: "orion_stats_semwait_metrics %f\n", value: stats.Semwait.Metrics},
		{text: "orion_stats_notif_queue_in %f\n", value: stats.NotifQueue.In},
		{text: "orion_stats_notif_queue_out %f\n", value: stats.NotifQueue.Out},
		{text: "orion_stats_notif_queue_reject %f\n", value: stats.NotifQueue.Reject},
		{text: "orion_stats_notif_queue_sent_ok %f\n", value: stats.NotifQueue.SentOk},
		{text: "orion_stats_notif_queue_sent_error %f\n", value: stats.NotifQueue.SentError},
		{text: "orion_stats_notif_queue_time_in_queue %f\n", value: stats.NotifQueue.AvgTimeInQueue},
		{text: "orion_stats_notif_queue_size %f\n", value: stats.NotifQueue.Size},
		{text: "orion_stats_notif_queue_in %f\n", value: stats.NotifQueue.In},
	} {
	...
	for url, metrics := range stats.Counters.Requests {
		for _, stat := range []urlStat{
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"GET\"} %f\n", url: url, value: metrics.Get},
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"POST\"} %f\n", url: url, value: metrics.Post},
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"PUT\"} %f\n", url: url, value: metrics.Put},
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"PATCH\"} %f\n", url: url, value: metrics.Patch},
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"DELETE\"} %f\n", url: url, value: metrics.Delete},
			{text: "orion_stats_counters_requests {url=\"%s\", method=\"HEAD\"} %f\n", url: url, value: metrics.Head},
		} {
			statslist = append(statslist, stat)
		}
	}
	for url, metrics := range stats.Counters.RequestsLegacy {
		for _, stat := range []urlStat{
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"GET\"} %f\n", url: url, value: metrics.Get},
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"POST\"} %f\n", url: url, value: metrics.Post},
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"PUT\"} %f\n", url: url, value: metrics.Put},
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"PATCH\"} %f\n", url: url, value: metrics.Patch},
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"DELETE\"} %f\n", url: url, value: metrics.Delete},
			{text: "orion_stats_counters_requests_legacy {url=\"%s\", method=\"HEAD\"} %f\n", url: url, value: metrics.Head},
		} {
			statslist = append(statslist, stat)
		}
	}
